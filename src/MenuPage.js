  ...
  return (
    <div id="MenuPage" className="container mt-5">
      ...
      <div className="row">
        <div className="col-md-6">
          <div className="card mb-4">
            ...
            <div className="card-body">
              ...
              <p className="card-text">R35.99</p>
            </div>
          </div>
        </div>
        ...
        <div className="col-md-6">
          <div className="card mb-4">
            <img src="https://img.freepik.com/free-photo/delicious-glazed-doughnuts-arrangement_23-2150674022.jpg?size=626&ext=jpg&ga=GA1.2.783724358.1697279446&semt=ais" className="card-img-top" alt="Item 2" />
            <div className="card-body">
        ...
        <div className="col-md-6">
          <div className="card mb-4">
            <img src="https://www.onceuponachef.com/images/2019/04/Lemon-Pound-Cake-10-scaled.jpg" className="card-img-top" alt="Item 2" />
            <div className="card-body">
